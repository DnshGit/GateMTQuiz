...
public class Calculations {
    ...
    public Calculations(Context ct){
        ...
        binaryOperators.add("logxBasey");
        binaryOperators.add("e+");
        binaryOperators.add("%");
        binaryOperators.add("/");
        binaryOperators.add("*");
        binaryOperators.add("+");
    ...
    public String evaluateUnary(String operation, String value){
    ...
    private String evaluateBinary(String number1, String operation, String number2){
        ...
        switch (operation){
            ...
            case "mod":
                ...
                break;
            case "e+":
                answer = Exp(number1, number2);
                break;
            case "%":
                answer = percentile(number1, number2);
                break;
            case "logxBasey":
                answer = logxBasey(number1, number2);
                break;
            case "/":
    ...
    private String logXbase2(String num){
        return String.valueOf(Math.log10(Double.parseDouble(num))/Math.log10(2.0));
    }
    ...
    private String sin(String value){
        if (CalculatorActivity.angle.equals("Deg")) {
            return String.valueOf(Math.sin(convToRad(Double.parseDouble(value))));
        }else {
    ...
    private String cos(String value){
        if (CalculatorActivity.angle.equals("Deg")) {
            return String.valueOf(Math.cos(convToRad(Double.parseDouble(value))));
        }else {
    ...
    private String tan(String value){
        if (CalculatorActivity.angle.equals("Deg")) {
            return String.valueOf(Math.tan(convToRad(Double.parseDouble(value))));
        }else {
    ...
    private String asin(String value){
        if (CalculatorActivity.angle.equals("Deg")) {
            return String.valueOf(Math.asin(convToRad(Double.parseDouble(value))));
        }else {
    ...
    private String acos(String value){
        if (CalculatorActivity.angle.equals("Deg")) {
            return String.valueOf(Math.acos(convToRad(Double.parseDouble(value))));
        }else {
    ...
    private String atan(String value){
        if (CalculatorActivity.angle.equals("Deg")) {
            return String.valueOf(Math.atan(convToRad(Double.parseDouble(value))));
        }else {
    ...
    private String sinh(String value){
        if (CalculatorActivity.angle.equals("Deg")) {
            return String.valueOf(Math.sinh(convToRad(Double.parseDouble(value))));
        }else {
    ...
    private String cosh(String value){
        if (CalculatorActivity.angle.equals("Deg")) {
            return String.valueOf(Math.cosh(convToRad(Double.parseDouble(value))));
        }else {
    ...
    private String tanh(String value){
        if (CalculatorActivity.angle.equals("Deg")) {
            return String.valueOf(Math.tanh(convToRad(Double.parseDouble(value))));
        }else {
    ...
    @NonNull
    private String logxBasey(String num1, String num2){
        return String.valueOf(Math.log10(Double.parseDouble(num1)/Math.log10(Double.parseDouble(num2))));
    }

    private String Exp(String num1, String num2){
        return String.valueOf((Double.parseDouble(num1)*Math.pow(10,Double.parseDouble(num2))));
    }

    private String percentile(String num1, String num2){
        return String.valueOf((Double.parseDouble(num1)*Double.parseDouble(num2))/100);
    }
    ...
    private Double convToRad(Double degVal) {
        return (degVal/180)*3.14159265358979;
    }
}
